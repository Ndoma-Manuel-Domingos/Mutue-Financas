<template>
    <MainLayouts>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-light">
                                <button type="button" class="btn-sm btn-primary" @click="create">
                                    Nova Instituicão
                                </button>
                                        ...
                                        <tbody>
                                            <tr v-for="item in items.data" :key="item.codigo">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <!-- <a class="btn-sm btn-danger mr-1" @click="deleteItem(item)">
                                                        <i class="fa fa-link" title="Eliminar"> </i>
                                                    </a> -->
                                                    <a class="btn-sm btn-primary mr-1" @click="atribuirItem(item)">
                                                        <i class="fa fa-link" title="Associar tipo de bolsa a Instituições"> </i>
                                                    </a>
                                                    <a class="btn-sm btn-success mr-1" @click="visualizarBolsas(item)">
        ...
        <div class="modal" tabindex="-1" role="dialog" id="modalDeleteInstituicaoRenuncia">
        ...
        <div class="modal fade" id="modalAtribuirBolsa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Associar Bolsa a instituição</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body">
                        <form id="artribuirbolsaInst">
                            <div class="col-12 col-md-12">
                                ...
                                <span class="text-danger d-block">{{ form_atribuir.errors.tipo_bolsa }}</span>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" form="artribuirbolsaInst" @click.prevent="atribuir" class="btn btn-primary">Confirmar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="bolsasAssociadas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle() {
                return this.isUpdate ? "Editar Instituição Sem Renúncia" : "Adicionar Instituição Sem Renúncia";
            }
        },
        ...
        methods: {
            ...
            destroy() {
                this.$Progress.start();
                this.form.delete(route("instituicoes-sem-renuncia.destroy", this.itemId), {
                    preverseScroll: true,
                    onSuccess: () => {
                        this.itemId = null;
            ...
            atribuir(){
                this.$Progress.start();
                this.form_atribuir.post(route("associar-bolsas-instituicao.store"), {
                    preverseScroll: true,
                    onSuccess: () => {
            ...
            submit() {
                ...
                if (this.isUpdate) {
                    this.form.put(route("instituicoes-sem-renuncia.update", this.itemId), {
                      preverseScroll: true,
                      onSuccess: () => {
                        this.isUpdate = false;
                        this.itemId = null;
            ...
            imprimirPDF() {
                window.open("/instituicoes-sem-renuncia-pdf?tipo_instituicao=1", "_blank");
            },
            
            imprimirEXCEL() {
                window.open("/instituicoes-sem-renuncia-excel?tipo_instituicao=1", "_blank");
            }
        },
    }
