...
export default{
  ...
  methods: {
    ...
    imprimirPDF () {
      window.open("/relatorios/listar-estudantes-desconto-imprimir-pdf?tipo_instituicao="+this.tipo_instituicao+"&desconto="+this.tipo_desconto+"&instituicao="+this.instituicao, "_blank");
    },

    imprimirEXCEL () {
      window.open("/relatorios/listar-estudantes-desconto-imprimir-excel?tipo_instituicao="+this.tipo_instituicao+"&desconto="+this.tipo_desconto+"&instituicao="+this.instituicao, "_blank");
    }
  }
