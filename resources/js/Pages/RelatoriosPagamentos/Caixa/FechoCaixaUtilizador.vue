              ...
              <div class="row">
                ...
                <div class="col-12 col-md-2">
                  <div class="form-group">
                    ...
                    <input type="date" @keyup.enter="search" v-model="data_inicio" class="form-control form-control-sm " />
                  </div>
                </div>
                ...
                <div class="col-12 col-md-2">
                  <div class="form-group">
                    ...
                    <input type="date" @keyup.enter="search" class="form-control form-control-sm " v-model="data_final" />
                  </div>
                </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      imprimirPDF() {
        window.open("/fecho/caixa-utilizador/pdf-imprimir?estado_pagamento="+this.estado_pagamento+"&codigo_produto="+this.codigo_produto+"&parcela_mes_temp="+this.parcela_mes_temp+"&data_inicio="+this.data_inicio+"&data_final="+this.data_final, "_blank");
      },
    
      imprimirEXCEL() {
        window.open("/fecho/caixa-utilizador/excel-imprimir?estado_pagamento="+this.estado_pagamento+"&codigo_produto="+this.codigo_produto+"&parcela_mes_temp="+this.parcela_mes_temp+"&data_inicio="+this.data_inicio+"&data_final="+this.data_final, "_blank");
      },
