              ...
              <div class="card-header bg-light">
                <div class="row">
                  ...
                  <div class="col-12 col-md-4">
                    <input
                      type="search"
                      v-model="filtro_estudante"
                      class="form-control"
                      placeholder="Pesquisar estudante pelo codigo da Pre-inscrição, Nome, Bilheite"
                    />
                  </div>
                  <div class="col-12 col-md-2">
                    <button
                      class="btn btn-primary"
                      @click="pesquisar_estudante"
                    >
                ...
                >
                  ...
                  <tbody>
                    <tr v-for="pagamento in items.data" :key="pagamento.Codigo">
                      <td v-if="pagamento.matricula">
                        <a
                          :href="`/estudantes/visualizar-perfil/${pagamento.matricula}`"
                          >{{ pagamento.matricula }}</a
                        >
                      </td>
                      <td v-else>#####</td>
          ...
          >
            <div class="modal-content">
                      ...
                      <table class="table table-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              {{ formatData(dados_pagamentos.data_banco) }}
                            </td>
                            <td>
                              {{ formatData(dados_pagamentos.data_registro) }}
                            </td>
                            <td>
                              {{ formatData(dados_pagamentos.data_validacao) }}
                            </td>
                          </tr>
              ...
              <div class="modal-footer">
                <a
                  @click="validar_pagamento(dados_pagamentos.recibo)"
                  class="btn btn-success"
                  >Validar</a
                >
                <a
                  @click="rejeitar_pagamento(dados_pagamentos.recibo)"
        ...
        >
          ...
          >
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title text-uppercase" id="exampleModalLabel">
                  Motivos da Rejeição do Pagamento
                </h5>
                <button
                  type="button"
                  class="close"
              ...
              <form action="">
                <div class="modal-body">
                  <div class="row">
                    <div class="col-12 col-md-12">
                      <div class="form-group">
                        <label for="" class="text-secondary"> Motivos </label>
                        <div class="input-group input-group">
                          <select
                            v-model="movito_rejeicao"
                            class="form-control form-control-sm"
                          >
                  ...
                  <a
                    @click="
                      confirmar_rejeicao_pagamento(dados_pagamentos.recibo)
                    "
                    class="btn btn-success"
                    >Confirmar</a
                  >
...
export default {
  ...
  methods: {
    ...
    confirmar_rejeicao_pagamento(codigo) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          axios
            .get(
              "../pagamento/rejeitar-pagamento/store/" +
                codigo +
                "/" +
                this.movito_rejeicao
            )
            .then((response) => {
    ...
    imprimirPDF() {
      window.open(
        `/pagamento/porvalidar-pdf?prestacao=${this.prestacao}&filtro_estudante=${this.filtro_estudante}&grau_academico=${this.grau_academico}&forma_pagamento=${this.forma_pagamento}&tipo_servico=${this.tipo_servico}&data_inicio=${this.data_inicio}&data_final=${this.data_final}`,
        "_blank"
      );
    },
    ...
    imprimirEXCEL() {
      window.open(
        `/pagamento/porvalidar-excel?prestacao=${this.prestacao}&filtro_estudante=${this.filtro_estudante}&grau_academico=${this.grau_academico}&forma_pagamento=${this.forma_pagamento}&tipo_servico=${this.tipo_servico}&data_inicio=${this.data_inicio}&data_final=${this.data_final}`,
        "_blank"
      );
    },
  },
