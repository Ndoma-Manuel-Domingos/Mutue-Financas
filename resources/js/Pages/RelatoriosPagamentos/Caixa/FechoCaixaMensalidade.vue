              ...
              <div class="row">
                ...
                <div class="col-12 col-md-2">
                  <div class="form-group">
                    ...
                    <input type="date" @keyup.enter="search" v-model="data_inicio_banco" class="form-control form-control-sm " />
                  </div>
                </div>
                ...
                <div class="col-12 col-md-2">
                  <div class="form-group">
                    ...
                    <input type="date" @keyup.enter="search" class="form-control form-control-sm " v-model="data_final_banco" />
                  </div>
                </div>
                ...
                <div class="col-12 col-md-2">
                  <div class="form-group">
                    ...
                    <input type="date" @keyup.enter="search" v-model="data_inicio_validacao" class="form-control form-control-sm " />
                  </div>
                </div>
                ...
                <div class="col-12 col-md-2">
                  <div class="form-group">
                    ...
                    <input type="date" @keyup.enter="search" class="form-control form-control-sm " v-model="data_final_validacao" />
                  </div>
                </div>
