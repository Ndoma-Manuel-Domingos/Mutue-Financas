...
use App\Http\Controllers\ConfirmacoesMatricula;
...
use App\Http\Controllers\TestControllwe;
...
Route::group(["middleware" => "auth"], function () {
    ...
    Route::get('/listagem-geral-estudantes', [ConfirmacoesMatricula::class, 'listagemGeralEstudantes']); //->name('mf.listagem-geral-estudantes');
    Route::get('/listar-estudantes-matriculados', [ConfirmacoesMatricula::class, 'listarEstudantesMatriculados']); //->name('mf.listar-estudantes-matriculados');
    Route::get('/listar-estudantes-por-estados', [ConfirmacoesMatricula::class, 'listarEstudantesPorEstado']); //->name('mf.listar-estudantes-por-estado');
    Route::get('/listar-estudantes-inscritos-em-unidades-curricular', [ConfirmacoesMatricula::class, 'listarEstudantesInscritoEmUnidadeCurricular']); //->name('mf.listar-estudantes-inscritos-em-unidades-curricular');
    Route::get('/listar-estudantes-personalizados', [ConfirmacoesMatricula::class, 'listarEstudantesPersonalizados']); //->name('mf.listar-estudantes-personalizados');
    ...
    // Route::post('/actualizar/Desconto/{id}',[GestaodeBolsaeDescontoController::class,'EditarTipoDesconto']);//->name('mf.update-Desconto');
    ...
    Route::put('/update-desconto-aluno/{item?}', [GestaodeBolsaeDescontoController::class, 'updateDesconto'])->name('mf.update-desconto');
    ...
    Route::get('/listagem-utilizadores', [UserController::class, 'lista_utilizadores']);
    Route::post('/criar-utilizadores', [UserController::class, 'criar_utilizadores']);
    Route::get('/roles/permissions/{id_user}', [UserController::class, 'getPermissionsRole']);
    Route::post('/roles/adicionar-permissions', [UserController::class, 'adicionar_permissions']);
    Route::get('/roles/utilizador-perfil/{id}', [UserController::class, 'getPerfilUtilizador']);
    Route::get('/roles/utilizador-remover-perfil/{id}', [UserController::class, 'removerPerfilUtilizador']);
    Route::post('/roles/utilizadores-roles', [UserController::class, 'adicionar_perfil_utilizador']); 
     ...
     Route::get('/estudante/pega-desconto-atribuido/{id_user}', [EstudanteController::class, 'descontoAtribuido']);
     Route::get('/estudante/verificar-bolseiro/{id_user}', [EstudanteController::class, 'verificar_estudante_bolseiro']);
     Route::get('/estudante/tipo-aluno/{id_user}', [EstudanteController::class, 'getTipoAluno']);
     Route::get('/estudante/pegar-valor-propina/{id_user}', [EstudanteController::class, 'recuperar_preco_propina']);
     Route::get('/estudante/pega-finalista/{id_user}', [EstudanteController::class, 'finalista']);
     Route::get('/estudante/pega-preco-propina/{polo}', [EstudanteController::class, 'getPrecoPropina']);
    //  Route::get('/estudante/estudante-dividas-valor-pago/{preisncricao}/{ano_lectivo}/{preco_unitario?}', [EstudanteController::class, 'estudanteDividasValorPago']);
    ...
    Route::get('/teste', [TestControllwe::class, 'test']);
