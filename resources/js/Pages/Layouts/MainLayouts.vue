    ...
    <div class="wrapper">
        ...
        <div class="mx-auto">
          <div class="input-group">
            <input
              ...
              type="search"
              @keyup.enter="search_estudante_metodo"
              v-model="search_estudante_geral_numero_de_matricula"
              placeholder="Pesquisar estudante por: Nº de Matricula,Nome,Telefone,BI"
              style="width: 450px"
            />
      ...
      <aside class="main-sidebar sidebar-secondary elevation-4">
        <Link
          href="/dashboard"
          class="brand-link"
          style="border-bottom: 1px solid #028bbf"
        >
          <img
            src="~admin-lte/dist/img/log1.png"
            class="img elevation-0"
            alt="User Image"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <tr
                v-for="est in estudante"
                :key="est.Codigo"
                class="table_estudantes"
              >
                <td>{{ est.inscricao }}</td>
                ...
                <td class="text-center">
                  <a
                    :href="`/estudantes/visualizar-perfil/${est.Codigo}`"
...
export default {
  ...
  methods: {
    ...
    search_estudante_metodo(e) {
      e.preventDefault();
      this.$Progress.start();
      $(".table_estudantes").html("");
      axios
        .get(
          "/estudantes/pesquisar-matricula/" +
            this.search_estudante_geral_numero_de_matricula
        )
        .then((response) => {
