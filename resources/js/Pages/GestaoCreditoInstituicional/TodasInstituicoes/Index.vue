                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr v-for="item in items.data" :key="item.codigo">
                      ...
                      <td>
                        {{
                          item.tipo_instituicao_descricao
                            ? item.tipo_instituicao_descricao.designacao
                            : ""
                        }}
                      </td>
                      <td>{{ item.contacto }}</td>
...
export default {
  ...
  methods: {
    ...
    imprimirPDF() {
      window.open(
        `/instituicoes-renuncia-pdf?tipo_instituicao=${this.instituicao_tipo}`,
        "_blank"
      );
    },
    ...
    imprimirEXCEL() {
      window.open(
        `/instituicoes-renuncia-excel?tipo_instituicao=${this.instituicao_tipo}`,
        "_blank"
      );
    },
  },
