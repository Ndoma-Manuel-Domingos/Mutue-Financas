...
class FechoGeralExport extends DefaultValueBinder implements FromCollection, WithMapping, WithTitle, WithHeadings, WithDrawings, WithStyles, WithCustomStartCell, WithCustomValueBinder, ShouldAutoSize
{
    ...
    public function __construct($request)
    {
        ...
        $this->titulo = "LISTAGEM DO FECHO DE CAIXA GERAL";
    }
    ...
    {
        return[
            $caixa->operador_novos ? $caixa->operador_novos->nome : "Estudante",
            $caixa->DataRegisto,
    ...
    */
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('E4', $operador->nome ?? 'TODOS');
