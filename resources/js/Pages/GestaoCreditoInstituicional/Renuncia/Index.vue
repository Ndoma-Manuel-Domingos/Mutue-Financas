    ...
    <MainLayouts>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-uppercase">Instituções Com Renúncias</h4>
                    </div>
                        ...
                        <form id="artribuirbolsaInst">
                            <div class="col-12 col-md-12">
                                <div class="input-group input-group">
                                    <select ref="mySelect" class="form-control form-control-sm  form-control" v-model="form_atribuir.tipo_bolsa" multiple>
                                        <option v-for="bolsa in listae_tipos_bolsas" :value="bolsa.id" :key="bolsa.id">{{ bolsa.text }}</option>
                                    </select>
                                </div>
...
<script>
    ...
    export default {
        props: ["items", "listae_tipos_bolsas", 'tipo_instituicao'],
        components: { Paginacao, Select2 },
        data() {
            return {
                itemId: null,
                instituicaoId: null,
        ...
        methods: {
            ...
            updateData() {
                this.$Progress.start();
                this.$inertia.get("/instituicoes-renuncia", this.params, {
                    preserveState: true,
                    preverseScroll: true,
                    onSuccess: () => {
