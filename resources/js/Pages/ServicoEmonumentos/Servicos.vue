        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a :href="route('mf.servicos-pdf')" target="_blink" class="btn btn-danger btn-sm float-sm-right mr-2"><i class="fas fa-file-pdf"></i> PDF</a>
              <a :href="route('mf.servicos-excel')" target="_blink" class="btn btn-success btn-sm float-sm-right mr-2"><i class="fas fa-file-excel"></i> Excel</a>
            </ol>
          </div>
        </div>
      </div>
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      <tr v-for="item in servicos.data" :key="item.Codigo">
                        ...
                        <td>
                          <a @click="editItem(item)" class="btn-sm btn-primary" href="#">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form @submit.prevent="submit" id="formTipoServico">
              ...
              <div class="form-group mb-3">
                ...
                <span class="text-danger d-block">{{ form.errors.tipoServico }}</span>
              </div>
            </form>
          ...
          <div class="modal-footer justify-content-between">
            ...
            <button type="submit" form="formTipoServico" class="btn-sm btn-primary">
              Salvar
            </button>
          </div>
        </div>
