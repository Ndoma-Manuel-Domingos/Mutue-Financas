                    ...
                    <table id="carregarTabelaEstudantes" style="width: 100%" class="table-sm table_estudantes table-bordered table-striped table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl table-responsive-xxl">
                      ...
                      <tbody>
                        <tr v-for="item in items.data" :key="item.codigo">
                          <td><a :href="route('mf.estudante-visualizar-perfil', item.codigo)">{{ item.codigo }}</a></td>
                          <td><a :href="route('mf.estudante-visualizar-perfil', item.codigo)">{{ item.nome }}</a></td>
                          <td>{{ item.bilheite }}</td>
                          <td>{{ item.faculdade }}</td>
                          <td>{{ item.curso }}</td>
                          <td>{{ item.periodo }}</td>
                          <td class="text-uppercase">{{ item.estado_matricula }}</td>
                        </tr>
                      </tbody>
                    </table>
                </div>
...
export default{
    ...
    methods: {
        ...
        imprimirPDF () {
          window.open("/relatorios/listar-estudantes-imprimir-pdf?anolectivo="+this.anolectivo+"&faculdade="+this.faculdade+"&curso="+this.curso+"&turno="+this.turno, "_blank");
        },
      
        imprimirEXCEL () {
          window.open("/relatorios/listar-estudantes-imprimir-excel?anolectivo="+this.anolectivo+"&faculdade="+this.faculdade+"&curso="+this.curso+"&turno="+this.turno, "_blank");
        }
    }
