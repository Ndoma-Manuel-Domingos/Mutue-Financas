            ...
            <div class="row">
              ...
              <div class="col-12 col-md-3">
                <div class="form-group">
                  ...
                  <input v-model="data_inicio" type="date" class="form-control"/>
                </div>
              </div>
              ...
              <div class="col-12 col-md-3">
                <div class="form-group">
                  ...
                  <input v-model="data_final" type="date" class="form-control"/>
                </div>
              </div>
              ...
              <table class="table table-hover text-nowrap">
                ...
                <tbody>
                  <tr v-for="pagamento in items.data" :key="pagamento.Codigo">
                    ...
                    <td>{{ pagamento.utilizadores ? pagamento.utilizadores.nome : '' }}</td>
                    <td>{{ pagamento.Data ?? '===' }}</td>
                    <td colspan="2"><a target="_blink"  :href="'https://mutue.ao/storage/documentos/'+pagamento.nome_documento" class="btn btn-primary btn-sm"> Visualizar </a></td>
                  </tr>
                </tbody>
              </table>
            </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      imprimirPDF() {
        window.open("/talao/desuso-pdf?o="+this.operador+"&di="+this.data_inicio+"&df="+this.data_final, "_blank");
      },

      imprimirEXCEL(){
        window.open("/talao/desuso-excel?o="+this.operador+"&di="+this.data_inicio+"&df="+this.data_final, "_blank");
      }
    }
