<template>
    <MainLayouts>
                                        ...
                                        <tbody>
                                            <tr v-for="item in items.data" :key="item.codigo">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class="btn-sm btn-info mr-1" @click="visualizarInstituicao(item)">
                                                        <i class="fas fa-home" title="Visualizar instituições"> </i>
                                                    </a>
                                                </td>
                                            </tr>
                                        </tbody>
        ...
        <div class="modal fade" id="modalTipoBolsa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" form="salvarTipoBolsa" class="btn text-white"  @click.prevent="submit" style="background-color: #6dd5ed;">Salvar</button>
                    </div>
                </div>
            </div>
        </div>

        <div class="modal fade" id="instituicaoAssociadas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-uppercase" id="exampleModalLabel">Instituições Associadas a esta Bolsa</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
