        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-uppercase">
              Listar Estudantes Com Creditos Educacional
            </h4>
          </div>
          <div class="col-sm-6">
            <a
...
export default {
  ...
  methods: {
    updateData() {
      this.$Progress.start();
      this.$inertia.get(
        "/relatorios/listar-estudantes-credito-instituicao",
        this.params,
        {
          preserveState: true,
          preverseScroll: true,
    ...
    imprimirPDF() {
      window.open(
        "/relatorios/listar-estudantes-credito-instituicao-imprimir-pdf?tipo_instituicao=" +
    ...
    imprimirEXCEL() {
      window.open(
        "/relatorios/listar-estudantes-credito-instituicao-imprimir-excel?tipo_instituicao=" +
          this.tipo_instituicao +
          "&instituicao=" +
          this.instituicao +
          "&bolsa=" +
