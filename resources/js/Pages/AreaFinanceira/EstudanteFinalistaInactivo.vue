        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-uppercase">
              LISTA DE ESTUDANTES FINALISTAS INACTIVOS
            </h4>
          </div>
          <div class="col-sm-6">
            <a
                ...
                >
                  ...
                  <tbody>
                    <tr v-for="item in estudantes.data" :key="item.matricula">
                      ...
                      <td>
                        <a
                          :href="`/estudantes/visualizar-perfil/${tem.matricula}`
                          "
                          >{{ item.nome ?? "nenhum" }}</a
                        >
                      </td>
...
export default {
  props: ["anolectivos", "cursos", "estudantes", "graus"],
  components: {
    Paginacao,
    Link,
  },
  ...
  methods: {
    ...
    imprimirPDF() {
      window.open(
        "/estudantes/finalista-inactivos/pdf?ano_inicio=" +
          this.ano_inicio +
          "&ano_final=" +
          this.ano_final +
          "&grau=" +
    ...
    imprimirEXCEL() {
      window.open(
        "/estudantes/finalista-inactivos/excel?ano_inicio=" +
          this.ano_inicio +
          "&ano_final=" +
          this.ano_final +
          "&grau=" +
