                      ...
                      <div class="input-group input-group">
                        ...
                        >
                          ...
                          <option
                            ...
                            v-for="instituicao in instituicao"
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group input-group">
                        ...
                        >
                          ...
                          <option
                            :value="bolsa.codigo"
                            v-for="bolsa in listagem_das_bolsas"
                            :key="bolsa.codigo"
                          >
                            {{ bolsa.designacao }}
                          </option>
              ...
              <div class="card-header bg-light">
                <h5>
                  <span class="float-left"
                    >TOTAL REGISTROS: {{ listarbolseiro.total }}</span
                  >
                </h5>
              </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-center">
                        <input
                          type="text"
                          v-model="busca_matricula_lsitagem_bolseiros"
                          class="form-control form-control-sm"
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="busca_nome_lsitagem_bolseiros"
                          name=""
                          class="form-control form-control-sm"
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="busca_curso_lsitagem_bolseiros"
                          name=""
                          class="form-control form-control-sm"
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="busca_tipo_bolsa_lsitagem_bolseiros"
                          name=""
                          class="form-control form-control-sm"
                          placeholder="Informe o tipo de bolsa"
                        />
                      </td>
                      <td>
                        <input
                          type="text"
                          v-model="busca_desconto_lsitagem_bolseiros"
                          name=""
                          class="form-control form-control-sm"
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="busca_estado_lsitagem_bolseiros"
                          disabled
                          class="form-control form-control-sm"
                      ...
                      <td>
                        <input
                          type="text"
                          disabled
                          v-model="busca_semestre_lsitagem_bolseiros"
                          class="form-control form-control-sm"
                      ...
                      <td>
                        <input
                          type="text"
                          v-model="busca_instituicao_lsitagem_bolseiros"
                          class="form-control form-control-sm"
                          placeholder="Informe a instittuição"
                        />
                      </td>
                    </tr>
                    <tr
                      v-for="item in listarbolseiro.data"
                      :key="item.bolseiro"
                    >
                      <td>{{ item.codigo }}</td>
                      <td class="text-center">
                      ...
                      <!-- <td class="text-center">{{ item.anoLectivo }}</td> -->
                      <td>
                        <div class="flex">
                            <a
                              @click="editItem(item)"
                              class="btn-sm btn-success mx-1"
                              v-if="user.auth.can['EDITAR BOLSEIROS']"
                              ><i class="fas fa-edit"></i
                            ></a>
                            <a
                              @click="showItem(item)"
                              class="btn-sm btn-info mx-1"
                              v-if="user.auth.can['VISUALIZAR BOLSEIROS']"
                              ><i class="fas fa-eye"></i
                            ></a>
                            <a
                              @click="mudarStatusItem(item)"
                              v-if="item.status == 0 && user.auth.can['MUDAR ESTADO BOLSEIROS']"
                              class="btn-sm btn-danger mx-1"
                              ><i class="fas fa-ban"></i
                            ></a>
                            <a
                              @click="mudarStatusItem(item)"
                              v-if="item.status == 1 && user.auth.can['MUDAR ESTADO BOLSEIROS']"
                              class="btn-sm btn-success mx-1"
          ...
          <div class="modal-body">
            <table class="table table-sm table-hover table-bordered">
              <tbody>
                <tr>
                  <td colspan="2">
                    Número Matrícula: <strong>{{ matricula.Codigo }}</strong>
                  </td>
                  <td colspan="2">
                    B.I ou Passaport:
                    <strong>{{ aluno.Bilhete_Identidade }}</strong>
                  </td>
                </tr>

                <tr>
                  <td colspan="2">
                    Nome Completo: <strong>{{ aluno.Nome_Completo }}</strong>
                  </td>
                  <td colspan="2">
                    Data de Emissão:
                    <strong>{{ aluno.data_emissao_bi }}</strong>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td colspan="2">
                    Data de Validade:
                    <strong>{{ aluno.data_validade_bi }}</strong>
                  </td>
                </tr>

                <tr>
                  <td colspan="2">
                    Género: <strong>{{ aluno.Sexo }}</strong>
                  </td>
                  <td colspan="2">
                    Telefone: <strong>{{ aluno.Contactos_Telefonicos }}</strong>
                  </td>
                </tr>

                <tr>
                  <td colspan="2">
                    Estado Civil: <strong>{{ aluno.Estado_Civil }}</strong>
                  </td>
                  <td colspan="2">
                    Telefone Alternativo:
                    <strong>{{ aluno.contacto_de_emergencia }}</strong>
                  </td>
                </tr>
                ...
                <tr>
                  <td colspan="2">
                    ...
                    <!-- <strong>{{ aluno.Naturalidade ?? 'Nenhum' }}</strong> -->
                  </td>
                  <td colspan="2">
                    Email: <strong>{{ aluno.Email }}</strong>
                  </td>
                </tr>

                <tr>
                  <td colspan="2">
                    Morada: <strong>{{ aluno.Morada_Completa ?? "" }}</strong>
                  </td>
                  <td colspan="2">
                    Atribuida Por: <strong>{{ bolsa.nome }}</strong>
                  </td>
                </tr>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group input-group">
                    ...
                    >
                      <option
                        :value="item.codigo"
                        v-for="item in listagem_das_bolsas"
                        :key="item.codigo"
                      >
                        {{ item.designacao }}
                      </option>
...
export default {
  ...
  data() {
    return {
      ...
      // BUSCAS START
      busca_matricula_lsitagem_bolseiros: "",
      busca_nome_lsitagem_bolseiros: "",
      busca_curso_lsitagem_bolseiros: "",
      busca_tipo_bolsa_lsitagem_bolseiros: "",
      busca_desconto_lsitagem_bolseiros: "",
      busca_estado_lsitagem_bolseiros: "",
      busca_semestre_lsitagem_bolseiros: "",
      busca_instituicao_lsitagem_bolseiros: "",
      // BUSCAS END
  ...
  watch: {
    ...
    ano_lectivo_selecionado: function (val) {
      this.params.ano_lectivo_selecionado = val;
      this.updateData();
    },
    Curso: function (val) {
    ...
    busca_matricula_lsitagem_bolseiros: function (val) {
      this.params.busca_matricula_lsitagem_bolseiros = val;
      this.updateData();
    },

    busca_nome_lsitagem_bolseiros: function (val) {
      this.params.busca_nome_lsitagem_bolseiros = val;
      this.updateData();
    },

    busca_curso_lsitagem_bolseiros: function (val) {
      this.params.busca_curso_lsitagem_bolseiros = val;
      this.updateData();
    },

    busca_tipo_bolsa_lsitagem_bolseiros: function (val) {
      this.params.busca_tipo_bolsa_lsitagem_bolseiros = val;
      this.updateData();
    },

    busca_desconto_lsitagem_bolseiros: function (val) {
      this.params.busca_desconto_lsitagem_bolseiros = val;
      this.updateData();
    },

    busca_estado_lsitagem_bolseiros: function (val) {
      this.params.busca_estado_lsitagem_bolseiros = val;
      this.updateData();
    },

    busca_semestre_lsitagem_bolseiros: function (val) {
      this.params.busca_semestre_lsitagem_bolseiros = val;
      this.updateData();
    },
    
    busca_instituicao_lsitagem_bolseiros: function (val) {
      this.params.busca_instituicao_lsitagem_bolseiros = val;
      this.updateData();
    },
  },
  ...
  methods: {
    ...
    confirmarMudarStatus() {
      this.$Progress.start();
      this.$inertia.get(
        "/mudar-estado-bolseiros/" + this.itemId,
        {},
        {
          preserveState: true,
          preverseScroll: true,
    ...
    submit() {
      this.form.put(`/update-bolseiros/${this.itemId}`, {
        preverseScroll: true,
        onSuccess: () => {
          this.isUpdate = false;
          this.itemId = null;
    ...
    imprimirPDF() {
      window.open(
        "/listagem/bolserios/pdf-imprimir?AnoLectivo=" +
    ...
    imprimirExcel() {
      window.open(
        "/listagem/bolserios/excel-imprimir?AnoLectivo=" +
          this.ano_lectivo_selecionado +
          "&Curso=" +
          this.Curso +
          "&Instituicao=" +
