                    ...
                    <tr>
                      ...
                      <td>
                        <input
                          type="text"
                          class="form-control"
                          v-model="nome_instituicao_search"
                      ...
                      <td>
                        <input
                          type="text"
                          class="form-control"
                          v-model="sigla_instituicao_search"
                      ...
                      <td>
                        <input
                          type="text"
                          class="form-control"
                          v-model="nif_instituicao_search"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="salvarInstuicao" class="row">
              ...
              <div class="form-group col-12 col-md-6">
                <label for="recipient-name" class="col-form-label"
                  >Tipo de Instituição <span class="text-danger">*</span></label
                >
                <select
                  name="tipo"
                  class="form-control form-control-sm mb-1"
              ...
              <div class="form-group col-12 col-md-6">
                ...
                >
                  <option
                    v-for="bolsa in listae_tipos_bolsas"
                    :value="bolsa.id"
                    :key="bolsa.id"
                  >
                    {{ bolsa.text }}
...
export default {
  ...
  computed: {
    formTitle() {
      return this.isUpdate
        ? "Editar Instituição Com Renúncia"
        : "Adicionar Instituição Com Renúncia";
    },
  ...
  methods: {
    ...
    editItem(item) {
      ...
      (this.form.tipos_bolsas = []), (this.isUpdate = true);
    ...
    submit() {
      ...
      if (this.isUpdate) {
        ...
        axios.put(`/instituicoes-renuncia/${this.itemId}`, { data: 'novo conteúdo' })
          .then(response => {
            this.isUpdate = false;
            this.itemId = null;
            this.form.reset();
        ...
        axios.post('/instituicoes-renuncia', this.form)
          .then(response => {
            this.form.reset();
            this.$Progress.finish();
            sweetSuccess("Dados salvos com sucesso");
